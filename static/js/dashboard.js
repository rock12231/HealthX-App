...
(function($) {
  ...
  $(function() {
    ...
    if ($("#visit-sale-chart-dark").length) {
      ...
      var gradientStrokeCoral = ctx.createLinearGradient(0, 0, 0, 320);
      gradientStrokeCoral.addColorStop(0, 'rgba(255, 191, 150, 1)');
      gradientStrokeCoral.addColorStop(1, 'rgba(254, 112, 150, 1)');
      var gradientStrokeCoral = 'linear-gradient(to right, rgba(255, 191, 150, 1), rgba(254, 112, 150, 1))';
    ...
    if ($("#traffic-chart").length) {
      ...
      var gradientStrokeCoral = ctx.createLinearGradient(0, 0, 0, 300);
      gradientStrokeCoral.addColorStop(0, 'rgba(255, 127, 80, 1)');
      gradientStrokeCoral.addColorStop(1, 'rgba(240, 128, 128, 1)');
      var gradientLegendCoral = 'linear-gradient(to right, rgba(255, 127, 80, 1), rgba(240, 128, 128, 1))';


      var trafficChartData = {
        datasets: [{
          data: [
            Math.round((mydata['chest_pain'] / mydata['total'])*100),
            Math.round((mydata['chest_pain1'] / mydata['total'])*100),
            Math.round((mydata['chest_pain2'] / mydata['total'])*100),
            Math.round((mydata['chest_pain3'] / mydata['total'])*100),
            ],
          backgroundColor: [
            gradientStrokeBlue,
            gradientStrokeGreen,
